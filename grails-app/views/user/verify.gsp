...
<g:form class="form-horizontal" controller="user" action="reset" >
<fieldset>
<div class="form-group" ${hasErrors(bean: userInstance, field: 'name', 'error')}>
<label for="name"><h5>Email :</h5></label>
<input class="form-control" placeholder="Enter Your Email" id="email" name="email" value="${userInstance?.email}" type="email" required>
</div>
<!-- Change this to a button or input when using this as a form -->
<input type="submit" id="btnsave"  class="btn btn-lg btn-primary btn-block" value="Verify" onclick="return validateForm()"  >
<br><br><br><br>
</fieldset>
</g:form>
</div>
