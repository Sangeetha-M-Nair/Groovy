...
<label for="name"><h5>New Password :</h5></label>
<input class="form-control" value="" id="newpass" name="newpass" type="password" required>
</div>
<div class="form-group" ${hasErrors(bean: userInstance, field: 'password', 'error')}>
<label for="password"><h5>Confirm Password :</h5></label>
<input class="form-control" value="" id="confirmpass" name="confirmpass" type="password" required>
</div>
<input type="hidden" id="email" name="email" value=""> 
<!-- Change this to a button or input when using this as a form-->
<input type="submit" class="btn btn-lg btn-primary btn-block" value="Save" onclick="return validateForm()"  >
<br><br><br><br>
</fieldset>
</g:form>
</div>
