...
<g:form controller="user" name="employeeLogin" id="employeeLogin" action="authenticate" >
<fieldset>
<div class="form-group" ${hasErrors(bean: userInstance, field: 'name', 'error')}>
<label for="name"><h5>Name :</h5></label>

<input class="form-control" placeholder="Enter Name" id="name" name="name" onclick="employeeLogin" value="${userInstance?.name}"type="text" required>
</div>
<div class="form-group" ${hasErrors(bean: userInstance, field: 'password', 'error')}>
<label for="password"><h5>Password :</h5></label>
<input class="form-control" placeholder="Enter Password" id="password" name="password" onclick="employeeLogin" value="${userInstance?.password}" type="password" required>
</div>
<div class="input-group-append">
    <span class="input-group-text">
    <a href="#" class="text-dark" id="eye-click"><i id="eye" class="far fa-eye"></i></a>
    </span>
  </div>
</div>

<!-- Change this to a button or input when using this as a form -->
 <input type="Submit" id="employeeLogin" name="employeeLogin"  class="btn btn-lg btn-primary btn-block" value="Login" onclick="return validateForm()"  >
<a href="/KMIS/user/verify.gsp">Forgot Password?</a>
<br><br><br><br>
</fieldset>
</g:form>
...
<script>
function validateForm() {
var x = document.forms["password"].value;
if (x == "") {
